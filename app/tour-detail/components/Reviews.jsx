  ...
  const reviews = [
    {
      ...
      date: "Mar 12 2022",
      rating: 4,
      review: "I recently stayed at Tree house Hotel, and it was a pleasant experience overall. I’d recommend Blissful Stay Resort for its comfort and ....",
      avatar: "/image/22.jpg",
    },
    {
      name: "Gus Fring",
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {reviews.map((review, index) => (
          <div
            key={index}
            className="bg-white p-4 rounded-lg flex space-x-4"
          >
            <img
              src={review.avatar}
              alt={review.name}
            ...
            <div>
              ...
              <div className="flex space-x-1 my-2">{renderStars(review.rating)}</div>
