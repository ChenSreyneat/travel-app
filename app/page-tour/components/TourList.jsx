...
import Pagination from "../../page-tour/components/Pagination"; // Adjust path as needed
import "@fortawesome/fontawesome-free/css/all.min.css";

// Updated datasets with more items to test pagination
const highestPriceData = Array(10).fill({
  title: "Phnom Penh, Angkor Wat and Kompot",
  description: "Experience the dazzling lights of the Las Vegas Strip and beyond with a nighttime helicopter flight.",
  rating: 4.8,
  reviews: 112,
  duration: "2 Weeks",
  status: "Sold out",
...
const lowestPriceData = Array(10).fill({
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <p
                    className={`text-sm font-bold ${
                      card.status === "Sold out" ? "text-red-500" : "text-green-500"
                    }`}
                  >
                    {card.status}
                  </p>
