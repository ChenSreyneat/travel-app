        ...
        <nav className="bg-white shadow-md h-[100px]">
            <div className="flex items-center justify-between max-w-7xl mx-auto px-4 h-full">
                ...
                <div className="hidden md:flex space-x-7">
                    <Link href="/" className="text-green-700 hover:text-green-900 flex items-center space-x-2" aria-label="Home">
                        <i className="fa-solid fa-house"></i>
                        <span>Home</span>
                    </Link>
                    <Link href="/about" className="text-green-700 hover:text-green-900 flex items-center space-x-2" aria-label="About">
                        <i className="fa-solid fa-users"></i>
                        <span>About</span>
                    </Link>
                    <Link href="/contact" className="text-green-700 hover:text-green-900 flex items-center space-x-2" aria-label="Contact">
